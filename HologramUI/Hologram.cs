...
namespace ClientSideTest.HologramUI
{
    ...
    public class Hologram : UIElement
    {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw((Texture2D)ModContent.Request<Texture2D>("ClientSideTest/Assets/Blank"), basePos, null, color, 0f, Vector2.Zero, scale / 1.2f, SpriteEffects.None, 0f);
